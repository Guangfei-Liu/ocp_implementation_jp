...
+
----
[root@master00-GUID ~]# oc create -f registry-volume.json
...
+
----
[root@master00-GUID ~]# oc create -f registry-volume-claim.json
...
[root@master00-GUID ~]# oc edit dc docker-registry -o json
----
