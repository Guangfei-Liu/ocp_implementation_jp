...
+
We’ve seen this page before, but now it contains something new — an "Instant App(lication)".
An instant app is a "special" kind of template (in reality, it just has the "instant-app" tag). . 
The idea behind an
