...
link:https://github.com/sborenst/ruby-hello-world[https://github.com/sborenst/ruby-hello-world]
...
[marina@master00 ~]$ oc login -u andrew --insecure-skip-tls-verify --server=https://master00-${guid}.oslab.opentlc.com:8443
[marina@master00-GUID ~]$ oc project lifecycle
----

. Lets create an app based on the link:https://github.com/sborenst/ruby-hello-world[https://github.com/sborenst/ruby-hello-world.git] repo
+
----
[marina@master00-GUID ~]$ oc new-app https://github.com/sborenst/ruby-hello-world.git
----
+
