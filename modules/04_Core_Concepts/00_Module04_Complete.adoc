...
Welcome to module four of the OpenShift Container Platform Implementation course.

This module presents some of the core concepts in OpenShift Container Platform 3.
...
This module provides high-level architectural information on core concepts and
 objects you will encounter when using OpenShift Container Platform.

Many of these objects come from the Kubernetes Project. OpenShift Container Platform
