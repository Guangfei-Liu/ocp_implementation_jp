...
Many of these objects come from Kubernetes. OpenShift Enterprise expands
 Kubernetes to provide a more feature-rich development lifecycle platform.
...
* Pods and services, which let containers communicate with each other and with
 proxy connections
