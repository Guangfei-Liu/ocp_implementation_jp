...
The `Default Router` then selects a pod from the list of pods listed by the
...
* OpenShift Container Platform version 3.5 now available
...
OpenShift Container Platform version 3.5 is now available.
