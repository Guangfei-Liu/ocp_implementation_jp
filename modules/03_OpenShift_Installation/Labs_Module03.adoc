...
. On the master00 host, examine the docker storage configuration:
+
----
...
+
----
[root@master00-2642 ~]# oadm registry  --credentials=/etc/openshift/master/openshift-registry.kubeconfig  --images='registry.access.redhat.com/openshift3/ose-docker-registry:v3.0.0.1' --selector='region=infra'
----
...
NOTE: The installer will already import most of the ImageStreams and Templates for you.
+
. core set of image streams, that use the Red Hat Enterprise Linux (RHEL) 7 based images:
----
