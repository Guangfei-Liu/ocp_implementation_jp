...
[marina@master00-c0fe ruby-hello-world]$ oc new-app . --docker-image=registry.access.redhat.com/openshift3/ruby-20-rhel7
----
...
. Click the *+* button at the top (to the right of `bin` in the breadcrumb).
