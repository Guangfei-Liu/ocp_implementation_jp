...
[root@master00-GUID ~]# scp /etc/yum.repos.d/open.repo node00-$GUID.oslab.opentlc.com:/etc/yum.repos.d/open.repo
[root@master00-GUID ~]# scp /etc/yum.repos.d/open.repo node01-$GUID.oslab.opentlc.com:/etc/yum.repos.d/open.repo
[root@master00-GUID ~]# scp /etc/yum.repos.d/open.repo infranode00-$GUID.oslab.opentlc.com:/etc/yum.repos.d/open.repo
...
[root@master00-GUID ~]# ssh root@infranode00-$GUID.oslab.opentlc.com "yum -y install docker; rm -rf /var/lib/docker/* ; sed -i \"s/OPTIONS.*/OPTIONS='--selinux-enabled --insecure-registry 0.0.0.0\/0'/\" /etc/sysconfig/docker;"
[root@master00-GUID ~]# ssh root@node00-$GUID.oslab.opentlc.com "yum -y install docker; rm -rf /var/lib/docker/* ; sed -i \"s/OPTIONS.*/OPTIONS='--selinux-enabled --insecure-registry 0.0.0.0\/0'/\" /etc/sysconfig/docker;"
[root@master00-GUID ~]# ssh root@node01-$GUID.oslab.opentlc.com "yum -y install docker; rm -rf /var/lib/docker/* ; sed -i \"s/OPTIONS.*/OPTIONS='--selinux-enabled --insecure-registry 0.0.0.0\/0'/\" /etc/sysconfig/docker;"
...
[root@infranode-GUID ~]# systemctl start docker
