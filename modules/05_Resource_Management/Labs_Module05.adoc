...
Name:				hello-openshift
Namespace:			resourcemanagement
Image(s):			openshift/hello-openshift:v1.2.1
...
Events:
  ...
  4m		4m		1	{kubelet node1.example.com}	spec.containers{hello-openshift}	Pulled		Container image "openshift/hello-openshift:v1.2.1" already present on machine
