...
baseurl=http://www.opentlc.com/repos/ose_implementation/3.1/rhel-7-server-extras-rpms
enabled=1
gpgcheck=0
...
baseurl=http://www.opentlc.com/repos/ose_implementation/3.1/rhel-7-server-ose-3.1-rpms
enabled=1
gpgcheck=0
...
+
----
[root@oselab-GUID ~]# ssh master00-$guid.oslab.opentlc.com
----
